...
- decide whether retained documented root export
  `resolve_palace_materials_with_report()` should remain root, or move to
  `gsim.palace.materials` after a separate docs-contract review;
