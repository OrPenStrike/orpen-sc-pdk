# Straight + Bend Transition — Lead 100 µm

## Configuration

- Terminal order: `o1, o2, g_center, o3, o4`
- Lead/de-embed length: 100 µm
...
The literal `St(o2,o1)` mean magnitude is -38.763 dB raw and
-43.803 dB after native HFSS wave-port de-embedding. The two
...
- Notebook analyze call: 338.489 s
- Adaptive passes: 3
- Max tetrahedra: 208,738
- HFSS max matrix size (DoF proxy): 1,258,861
- Final Max Mag ΔS: 0.000474257
- Adaptive max memory/process: 8.86 GB
- Frequency-sweep total memory: 9.07 GB
...
- `straight_bend_lead100um_ground80um_deembed100um_dzo1pct_terminalmodes_seam5p.aedt`: solved AEDT project
- `straight_bend_lead100um_ground80um_deembed100um_dzo1pct_terminalmodes_seam5p.gds`: GDSFactory-exported coupon
