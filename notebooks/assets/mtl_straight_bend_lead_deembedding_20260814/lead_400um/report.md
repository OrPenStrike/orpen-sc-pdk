# Straight + Bend Transition — Lead 400 µm

## Configuration

- Terminal order: `o1, o2, g_center, o3, o4`
- Lead/de-embed length: 400 µm
...
The literal `St(o2,o1)` mean magnitude is -30.312 dB raw and
-38.800 dB after native HFSS wave-port de-embedding. The two
...
- Notebook analyze call: 1338.015 s
- Adaptive passes: 3
- Max tetrahedra: 827,955
- HFSS max matrix size (DoF proxy): 4,937,743
- Final Max Mag ΔS: 0.00594799
- Adaptive max memory/process: 28.7 GB
- Frequency-sweep total memory: 32.1 GB
...
- `straight_bend_lead400um_ground80um_deembed400um_dzo1pct_terminalmodes_seam5p.aedt`: solved AEDT project
- `straight_bend_lead400um_ground80um_deembed400um_dzo1pct_terminalmodes_seam5p.gds`: GDSFactory-exported coupon
