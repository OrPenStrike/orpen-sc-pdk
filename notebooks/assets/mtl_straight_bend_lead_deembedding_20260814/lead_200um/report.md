# Straight + Bend Transition — Lead 200 µm

## Configuration

- Terminal order: `o1, o2, g_center, o3, o4`
- Lead/de-embed length: 200 µm
...
The literal `St(o2,o1)` mean magnitude is -34.762 dB raw and
-41.637 dB after native HFSS wave-port de-embedding. The two
...
- Notebook analyze call: 600.478 s
- Adaptive passes: 3
- Max tetrahedra: 386,460
- HFSS max matrix size (DoF proxy): 2,322,477
- Final Max Mag ΔS: 0.00213277
- Adaptive max memory/process: 14.9 GB
- Frequency-sweep total memory: 15.7 GB
...
- `straight_bend_lead200um_ground80um_deembed200um_dzo1pct_terminalmodes_seam5p.aedt`: solved AEDT project
- `straight_bend_lead200um_ground80um_deembed200um_dzo1pct_terminalmodes_seam5p.gds`: GDSFactory-exported coupon
