# Straight + Bend Transition — Lead 150 µm

## Configuration

- Terminal order: `o1, o2, g_center, o3, o4`
- Lead/de-embed length: 150 µm
...
The literal `St(o2,o1)` mean magnitude is -36.500 dB raw and
-42.659 dB after native HFSS wave-port de-embedding. The two
...
- Notebook analyze call: 464.430 s
- Adaptive passes: 3
- Max tetrahedra: 306,347
- HFSS max matrix size (DoF proxy): 1,847,189
- Final Max Mag ΔS: 0.0031048
- Adaptive max memory/process: 12.5 GB
- Frequency-sweep total memory: 13 GB
...
- `straight_bend_lead150um_ground80um_deembed150um_dzo1pct_terminalmodes_seam5p.aedt`: solved AEDT project
- `straight_bend_lead150um_ground80um_deembed150um_dzo1pct_terminalmodes_seam5p.gds`: GDSFactory-exported coupon
