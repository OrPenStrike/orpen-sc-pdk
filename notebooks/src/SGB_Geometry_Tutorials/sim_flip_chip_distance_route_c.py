...
# %% [markdown]
# # Public SGB Sim Flip Chip Distance Route C
#
# This notebook recreates one public OrPen PDK geometry fixture for
# the Semantic Geometry Builder tutorial route `C`. It writes a
...
from orpen_sc_pdk.cells.chips import sim_flip_chip_distance
...
# %%
gf.clear_cache()
component = (sim_flip_chip_distance()).copy()
