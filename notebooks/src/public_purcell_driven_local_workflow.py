...
# %% [markdown]
# # Public Purcell Filter Driven local workflow
#
# This notebook demonstrates layout-authored Palace LumpedPort sheets on the
# public Global Purcell Filter Demo Chip. Only the two readout launcher sheets
# are declared as solver ports; mesh marker ports remain layout metadata.
...
NOTEBOOK_ROOT = PATH.simulation / "notebooks" / "public_purcell_driven_local_workflow"
...
if NOTEBOOK_PREPARE_RUN_STAGE:
    sim.set_driven(
        ...
        num_points=3,
        adaptive_tol=0,
        excitation_port="o_lumped_readout_in",
    )
