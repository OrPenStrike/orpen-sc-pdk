...
# %% [markdown]
# # Martinis 2022 Ribbon SGB Route A Native Mask Handoff
#
# This notebook uses Semantic Geometry Builder Route A for geometry and semantic
...
run_sgb_native_mask_handoff("A", analysis_run_root=ANALYSIS_RUN_ROOT)
