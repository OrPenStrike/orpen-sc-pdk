...
# %% [markdown]
# # Finite-ground CPW — HFSS Driven Modal
...
RUN_ID = "cpw_finite_ground_hfss_modal"
...
ports = (
    # Port ID, name, direction, and integration-line endpoints (um).
    ModalPort(1, "o1", "-X", ((-250.0, 0.0, 0.0), (-250.0, 20.0, 0.0))),
    ModalPort(2, "o2", "+X", ((250.0, 0.0, 0.0), (250.0, 20.0, 0.0))),
)
