...
# %% [markdown]
# # Public Surface EPR ribbon capacitor representation A workflow
#
# This notebook demonstrates Surface EPR representation A on the public OrPen
...
# `sim.set_surface_epr(...)`. The current public slice selects the MS channel
# only.
...
NOTEBOOK_ROOT = (
    PATH.simulation
    / "notebooks"
    / ("public_surface_epr_ribbon_capacitor_representation_a_workflow")
)
...
# postprocessing. This notebook only selects representation A plus the MS bottom
# entries for Martinis-style Surface EPR postprocessing.
...
if NOTEBOOK_PREPARE_RUN_STAGE:
    ...
    display(
        {
            "surface_epr_interfaces": ("MS bottom",),
...
if NOTEBOOK_PREPARE_RUN_STAGE:
    ...
    handoff_metadata = {
        ...
        "workflow": "public_surface_epr_ribbon_capacitor_representation_a_workflow",
    }
